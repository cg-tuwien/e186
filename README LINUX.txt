...
+ added the pregenerated GLAD OpenGL loader to the CMake build process. note: GLAD itself need not be installed, the OpenGL loader is generated by it and is platform independent.
https://github.com/Dav1dde/glad
+ assignment1 now running on Linux, with files specified in CMakeLists. later, ideally there should be a way to load scene files and assets and rebuild automatically
