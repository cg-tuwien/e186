...
namespace e186
{
	...
	PointLight::PointLight(const glm::vec3& color, const glm::vec3& position, float const_atten, float lin_atten, float quad_atten)
		//: m_transform( position ),
		: m_position(position),
		m_light_color(color),
	...
	PointLight::PointLight(const glm::vec3& color, Transform transform, float const_atten, float lin_atten, float quad_atten)
		//: m_transform( position ),
